...
const impacto = [
  ...
  { src: "/__l5e/assets-v1/a0a53beb-bd08-4b3e-b4c5-af943f6b5d65/apresentacao-tcc-banner-braille-unesp-zoomout.jpg", alt: "Luciane Molina lê texto em Braille em banner acessível.", caption: "Pesquisa acadêmica apresentada em banner acessível.", objectPos: "object-[center_10%]" },
  { src: "https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/luciane-lendo-placa-braille-na-praca-sensorial.jpg", alt: "Luciane Molina toca uma placa em Braille em praça sensorial.", caption: "Braille também ocupa os espaços públicos.", objectPos: "object-[center_10%]" },
];
    ...
    <div className="space-y-14">
      ...
      <section aria-labelledby="problema-title">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <Figura src="https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/maquina-perkins.jpg?v=3" alt="Máquina Perkins Brailler em metal cinza sobre fundo branco, com teclas pretas e placa do fabricante." caption="Máquina Perkins para produção de textos em Braille." />
