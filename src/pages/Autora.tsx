...
const galeriaServicos = [
  { src: "https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/alfabraille-v2.jpg", alt: "Conjunto de peças do alfabraille em azul e cinza.", caption: "Alfabraille como recurso concreto para o ensino." },
