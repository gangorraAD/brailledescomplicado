...
const trajetoria = [
  ...
  { src: "/luciane-lendo-no-memorial-zoomout.jpg", alt: "Luciane em pé ao lado de um banner em Braille, sorrindo e tocando o painel expositivo.", caption: "Experiência tátil e memória da acessibilidade." },
