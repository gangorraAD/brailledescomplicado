    ...
    <div className="space-y-14">
      ...
      <section aria-labelledby="problema-title">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <Figura src="https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/maquina-perkins.jpg" alt="Máquina Perkins de escrever em Braille sobre tecido vermelho, com folha escrita em Braille inserida." caption="Máquina Perkins para produção de textos em Braille." />
          <Figura src="https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/livro-ibc.jpg" alt="Livros do título A importância do Sistema Braille para a autonomia e independência da pessoa cega, em versões impressa e em Braille." caption="Publicação apresentada em versão impressa e em Braille." />
        </div>
      </section>
