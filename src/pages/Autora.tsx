    ...
    <div className="space-y-14">
      ...
      <section aria-labelledby="problema-title">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          ...
          <Figura src="https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/maquina-perkins.jpg?v=3" alt="Máquina Perkins Brailler em metal cinza sobre fundo branco, com teclas pretas e placa do fabricante." caption="Máquina Perkins para produção de textos em Braille." objectPos="object-[center_10%]" />
