...
const galeriaServicos = [
  ...
  { src: "https://ftoenhzwgfyhtecowrkd.supabase.co/storage/v1/object/public/book-images/luciane-mostrando-cela-braille-em-formacao.jpeg", alt: "Luciane Molina segura um alfabraille gigante em sala de aula.", caption: "Formação com materiais táteis e participação ativa.", objectPos: "object-[center_60%]" },
];
